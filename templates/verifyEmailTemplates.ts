...
const verifyEmail = function (verifyTokenLink: string) {
    const html = `
    <!DOCTYPE html>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            A request to create your ${APP_NAME} account was received.
Use this link to confirm your account and log in
    ...
    const text = `
        Verify Email, A request to create your ${APP_NAME} account was received.
        Use this link to confirm your account and log in`;
    return {
        html: html,
        text: text,
