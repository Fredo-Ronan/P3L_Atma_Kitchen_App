const APP_NAME = 'Atma Kitchen'
const COMPANY_EMAIL = 'atmakitchen@gmail.com'

const resetPasswordRequest = function (verifyTokenLink: string) {
    const html = `
    <!DOCTYPE html>
    ...
    <body
      ...
      <div style="display: none;">A request to create your ${APP_NAME} account was received.
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            A request to reset your password of ${APP_NAME} account was received.
Use this link to confirm your request and reset your password
                          </p>

                          <lable style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;">${verifyTokenLink}</lable>
                          ...
                          <p style="margin: 0 0 16px;">
                            ...
                            <a href="mailto:${COMPANY_EMAIL}" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">${COMPANY_EMAIL}</a>.
                          </p>
                          <p style="margin: 0 0 16px;">Thanks, <br>Atma Kitchen Support Team</p>
                        </td>
                      </tr>
                      <tr>
    ...
    const text = `
        Verify Email, A request to reset your password of ${APP_NAME} account was received.
        Use this link to confirm your request and reset your password`;
    return {
        html: html,
        text: text,
