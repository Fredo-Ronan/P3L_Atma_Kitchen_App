  ...
  return (
    <div>
      <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
        <Link className="text-3xl font-bold leading-none flex gap-4 items-center" href="#">
          ...
          <img src={`${process.env.BASE_URL}/assets/images/UAJY_LOGO.png`} className="h-16" alt="" />
          <p>Atma Kitchen</p>
        </Link>
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:gap-6 lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
          {NavbarRouteMap.map((element, index) => (
            <li key={index}>
              <Link className="text-lg text-gray-400 hover:text-gray-500" href={element.route}>
                {element.label}
              </Link>
            </li>
          ))}
      ...
      >
        ...
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          <div className="flex items-center mb-8">
            <Link className="mr-auto text-3xl font-bold leading-none flex items-center gap-4" href="#">
              <img src={`${process.env.BASE_URL}/assets/images/UAJY_LOGO.png`} className="h-16" alt="" />
              <p className="text-xl">Atma Kitchen</p>
            </Link>
            <button
