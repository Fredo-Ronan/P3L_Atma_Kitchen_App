...
const Keranjang = () => {
  ...
  const checkout = async () => {
    ...
    invoiceMaker(finalCurrentNoTransaksi, finalCurrentDate, items.at(0)?.TANGGAL_PENGIRIMAN! || itemsHampers.at(0)?.TANGGAL_PENGIRIMAN!, userData?.nama_customer!, alamat, selectedDeliveryType, items, itemsHampers, totalHarga, totalHarga, pakePoin ? poinTerpakai : 0, totalPoin, selectedDeliveryType === "delivery" ? "belum final" : "", 0);
